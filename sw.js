const CACHE = 'as-bon-sauveur-v5-20260907-5';
const ASSETS = [
  './','./index.html','./v3.css','./v4.css','./v5.css','./v4.js','./v5-preflight.js','./v5-patch.js','./v5-loop-fix.js','./v5-state-fix.js','./config.js','./manifest.webmanifest',
