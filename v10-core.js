...
function specialtyHome(){
 ...
 const hero=document.querySelector('.hero');if(hero){setText(hero.querySelector('.hero-kicker'),'BON SAUVEUR · SAINT-LÔ');setText(hero.querySelector('h1'),sp);setText(hero.querySelector('p'),'Rendez-vous, informations et appréciations de votre espace.');hero.querySelector('.hero-logo-stack')?.remove()}
...
refresh();window.ASV10={icons:I,refresh,version:'v10-20260907-3'};
})();
