...
function close(){document.getElementById('v23-privacy-modal')?.remove()}
function openPrivacy(){
  close();
  const w=document.createElement('div');
  w.id='v23-privacy-modal'; w.className='v19-modal-backdrop';
  w.innerHTML=
    '<div class="v19-modal wide v23-privacy-modal" role="dialog" aria-modal="true" aria-labelledby="v23-privacy-title">'+
      '<div class="v19-modal-head"><div><div class="v19-kicker">DONNÉES PERSONNELLES</div><h2 id="v23-privacy-title">Confidentialité & RGPD</h2></div><button class="v19-icon-btn" type="button" data-close aria-label="Fermer">×</button></div>'+
      '<div class="v19-modal-body">'+
        ...
        '<div class="v221-privacy-grid">'+
          ...
          '<section><h3>Durées de conservation</h3><ul><li>inscriptions : jusqu’à minuit le jour de l’événement ;</li><li>liste nominative d’une convocation : jusqu’à minuit le jour de l’activité ;</li><li>commandes : jusqu’au 1er juillet de l’année scolaire concernée ;</li><li>élèves, licences et appréciations sportives : jusqu’au 1er juillet de l’année scolaire concernée ;</li><li>bilans AS comportant des données personnelles : jusqu’au 1er juillet de l’année scolaire concernée ;</li><li>compteurs techniques anti-abus : 48 h ; V23 n’utilise plus de journal nominatif courant des tentatives PIN.</li></ul></section>'+
        ...
        '</div>'+
        '<div class="v221-privacy-version">Notice V23 · mise à jour : 15 septembre 2026</div>'+
      '</div>'+
    '</div>';
...
function injectFooter(){
  ...
  f.innerHTML='<button type="button" data-privacy>Données personnelles & RGPD</button><span>V23</span>';
