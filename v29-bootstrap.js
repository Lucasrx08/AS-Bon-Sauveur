(() => {
'use strict';
window.__BS_RELEASE={major:29,label:'V29',version:'29.0.0',channel:'stable'};
document.documentElement.dataset.appVersion='29';

function applyReleaseLabel(){
  document.documentElement.dataset.appVersion='29';
  document.querySelectorAll('.v221-privacy-footer span').forEach(el=>{if(el.textContent!=='V29')el.textContent='V29'});
}
