    ...
    '<div class="v19-modal wide v221-privacy-modal" role="dialog" aria-modal="true" aria-labelledby="v221-privacy-title">'+
      ...
      '<div class="v19-modal-body">'+
        ...
        '<div class="v221-privacy-grid">'+
          ...
          '<section><h3>Durées de conservation</h3><ul><li>inscriptions : 7 jours après l’événement ;</li><li>liste nominative d’une convocation : 7 jours après l’activité ;</li><li>commandes : jusqu’au 1er juillet de l’année scolaire concernée ;</li><li>élèves, licences et appréciations sportives : jusqu’au 1er juillet de l’année scolaire concernée ;</li><li>bilans AS comportant des données personnelles : jusqu’au 1er juillet de l’année scolaire concernée ;</li><li>compteurs techniques anti-abus : 48 h ; tentatives PIN : 30 jours maximum.</li></ul></section>'+
