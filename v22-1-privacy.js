    ...
    '<div class="v19-modal wide v221-privacy-modal" role="dialog" aria-modal="true" aria-labelledby="v221-privacy-title">'+
      ...
      '<div class="v19-modal-body">'+
        ...
        '<div class="v221-privacy-grid">'+
          ...
          '<section><h3>Base légale</h3><p>Les traitements sont mis en œuvre pour l’organisation du service scolaire et associatif sportif, la gestion des inscriptions et commandes demandées par les familles, et les obligations de suivi de l’établissement. Aucun usage publicitaire ni profilage commercial n’est réalisé.</p></section>'+
          '<section><h3>Qui peut y accéder ?</h3><p>Uniquement les personnels autorisés de l’Association Sportive et de l’établissement selon leur rôle. Les données techniques sont hébergées chez Supabase pour assurer le fonctionnement sécurisé de l’application.</p></section>'+
          '<section><h3>Durées de conservation</h3><ul><li>inscriptions : 90 jours après l’événement ;</li><li>liste nominative d’une convocation : 90 jours après l’activité ;</li><li>commandes : 12 mois maximum ;</li><li>élèves, licences et appréciations sportives : jusqu’au 1er octobre suivant l’année scolaire concernée ;</li><li>bilans AS comportant des données personnelles : 24 mois maximum ;</li><li>compteurs techniques anti-abus : 48 h ; tentatives PIN : 30 jours maximum.</li></ul></section>'+
